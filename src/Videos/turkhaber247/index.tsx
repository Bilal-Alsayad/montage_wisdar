...
export default function TurkHaber247Template({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/turkhaber247/fonts/MONTSERRATARABICBOLD.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/turkhaber247/images/logo.png")}
