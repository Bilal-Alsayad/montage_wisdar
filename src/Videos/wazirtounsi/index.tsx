...
const TITLE_STYLES: TitleAnimationStyles = {
  ...
  firstLine: {
    ...
    backgroundColor: "#E3E9DD",
    borderRight: "10px solid #014558",
  ...
  secondLine: {
    width: "fit-content",
    maxWidth: "100%",
    padding: "20px 56px 22px 36px",
    backgroundColor: "#B9CC98",
    borderRight: "10px solid #516C55",
    borderRadius: "0 0 28px 0",
    boxShadow: "-12px 12px 0 rgba(1, 69, 88, 0.5)",
    whiteSpace: "nowrap",
  },
};
...
export default function WazirTounsiTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/wazirtounsi/fonts/TajawalBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/wazirtounsi/images/logo.png")}
