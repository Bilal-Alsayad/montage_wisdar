...
export default function SpeakerAnimation({
  ...
  const whiteBgOpacity = interpolate(
    evalFrame,
    [WHITE_BG_OP_START, WHITE_BG_OP_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE },
  );
  const whiteBgSlideX = interpolate(
    evalFrame,
    [WHITE_BG_SL_START, WHITE_BG_SL_END],
    [-28, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE },
  );
  ...
  const nameLayerOpacity = interpolate(
    evalFrame,
    [NAME_LAYER_OP_START, NAME_LAYER_OP_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE },
  );
