...
const TITLE_STYLES: TitleAnimationStyles = {
  ...
  firstLine: {
    ...
    backgroundColor: "rgba(13, 16, 19, 0.94)",
    borderRight: "12px solid #E31B23",
    borderTop: "2px solid #9F1117",
    whiteSpace: "nowrap",
  },
  secondLine: {
    width: "fit-content",
    maxWidth: "100%",
    padding: "20px 48px 22px 34px",
    backgroundColor: "#6D090C",
    borderRight: "12px solid #9F1117",
    boxShadow: "0 12px 0 #07843C",
    whiteSpace: "nowrap",
  },
};
...
export default function ArrajelTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/arrajel/fonts/TajawalBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/arrajel/images/logo.png")}
