...
const TEMPLATE_FONT = "BigVestaArabicRegular";
const PRIMARY_COLOR = "#757575";
...
export default function HeadlineArTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/headlinear/fonts/BigVestaArabicRegular.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/headlinear/images/logo.png")}
        style={{ position: "absolute", top: 200, left: 54, width: 300 }}
      />
