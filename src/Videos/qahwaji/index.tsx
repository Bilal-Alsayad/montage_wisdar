...
const TITLE_STYLES: TitleAnimationStyles = {
  ...
  firstLine: {
    ...
    maxWidth: "100%",
    padding: "21px 50px",
    backgroundColor: "rgba(0, 20, 38, 0.91)",
    border: "3px solid #00749B",
    borderRadius: "12px 12px 0 0",
    boxShadow: "10px 0 0 #001122",
    whiteSpace: "nowrap",
  },
  secondLine: {
    width: "fit-content",
...
export default function QahwajiTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/qahwaji/fonts/TajawalBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/qahwaji/images/logo.png")}
