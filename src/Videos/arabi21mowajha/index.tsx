...
export default function Arabi21MowajhaTemplate({
  outroStartFrame,
  ...
  const fontsLoaded = useLoadFonts([
    {
      ...
      url: `${staticFile("arabi21mowajha/fonts/itfHuwiyaArabicBold.otf")}`,
    },
    {
      family: itfHuwiyaArabicMedium,
      url: `${staticFile("arabi21mowajha/fonts/itfHuwiyaArabicMedium.otf")}`,
    },
    {
      family: itfHuwiyaArabicRegular,
      url: `${staticFile("arabi21mowajha/fonts/itfHuwiyaArabicRegular.otf")}`,
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={outroStartFrame} durationInFrames={outroDurationInFrames}>
        <OffthreadVideo
          src={`${staticFile("arabi21mowajha/elements/outro.webm")}`}
          style={{ zIndex: 100 }}
          transparent
        />
      </Sequence>
      ...
      <Loop durationInFrames={LOGO_DURATION_FRAMES}>
        <OffthreadVideo
          src={`${staticFile("arabi21mowajha/elements/logo.webm")}`}
          style={{ zIndex: 99 }}
          transparent
        />
      </Loop>
