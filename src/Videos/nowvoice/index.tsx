...
const TEMPLATE_FONT = "AJannatLTBold";
const PRIMARY_COLOR = "#75368d";
...
export default function NowVoiceTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/nowvoice/fonts/AJannatLTBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/nowvoice/images/logo.png")}
        style={{ position: "absolute", top: 250, left: 70, width: 250 }}
      />
      ...
      {data.captions.src && (
        <Captions
          ...
          containerStyle={{
            ...
            textShadow: "0 0 50px 11.3px rgba(0, 0, 0, 0.62)",
            padding: "10px",
          }}
          textStyle={{
            color: "#bcbcbc",
