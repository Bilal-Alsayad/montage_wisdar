...
const TEMPLATE_FONT = "InfoplusHacenTunisiaBold";
const PRIMARY_COLOR = "#db0006";
...
export default function InfoplusTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("pulitkat/infoplus/fonts/HacenTunisiaBold.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("pulitkat/infoplus/images/logo.png")}
