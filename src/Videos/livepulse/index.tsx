...
const TEMPLATE_FONT = "AlJazeeraBold";
const PRIMARY_COLOR = "#5f7c96";
...
export default function LivePulseTemplate({data}: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/livepulse/fonts/AlJazeeraBold.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/livepulse/images/logo.png")}
