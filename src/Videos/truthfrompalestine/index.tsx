...
const TEMPLATE_FONT = "QudsNWMedium";
const PRIMARY_COLOR = "#3b038f";
...
const TITLE_STYLES: TitleAnimationStyles = {
  ...
  firstLine: {
    ...
    backgroundImage: `url("${staticFile(
      "truthfrompalestine/images/title1.png",
    )}")`,
  ...
  secondLine: {
    ...
    backgroundImage: `url("${staticFile(
      "truthfrompalestine/images/title2.png",
    )}")`,
    backgroundRepeat: "no-repeat",
    backgroundPosition: "center",
    backgroundSize: "100% 100%",
...
export default function TruthfrompalestineTemplate({
  data,
}: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("truthfrompalestine/fonts/QudsNWMedium.otf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("truthfrompalestine/images/gradiant.png")}
        style={{
          position: "absolute",
          bottom: 0,
        }}
      ...
      <Img
        src={staticFile("truthfrompalestine/images/logo.png")}
        style={{
          position: "absolute",
          bottom: 0,
        }}
