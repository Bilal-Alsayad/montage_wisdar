...
// Keep Img available for future logo activation.
void Img;
...
const TEMPLATE_FONT = "FrutigerLTArabicBlack";
const PRIMARY_COLOR = "#082f59";
...
export default function FactsInSecondsTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/factsinseconds/fonts/FrutigerLTArabicBlack.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/factsinseconds/images/logo.png")}
        style={{ position: "absolute", top: 280, left: 110, width: 200 }}
      />
