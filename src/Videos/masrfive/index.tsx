...
const TEMPLATE_FONT = "KufyanArabicBlack";
const PRIMARY_COLOR = "#0e7461";
...
export default function MasrFiveTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/masrfive/fonts/KufyanArabicBlack.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/masrfive/images/logo.png")}
