...
export default function CarthageFmTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/carthagefm/fonts/TajawalBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/carthagefm/images/logo.png")}
