    ...
    <AbsoluteFill>
      <Sequence from={0} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/carthagefm/images/location.png")}
        />

        <AnimatedTag
          text={date}
          styles={styles.date}
          iconSrc={staticFile("short/carthagefm/images/date.png")}
      ...
      <Sequence from={150} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/carthagefm/images/source.png")}
        />
      </Sequence>
    </AbsoluteFill>
  );
