...
const TITLE_STYLES: TitleAnimationStyles = {
  ...
  firstLine: {
    ...
    maxWidth: "100%",
    padding: "20px 52px",
    background: "linear-gradient(90deg, #123E34 0%, #1E6B57 100%)",
    borderRadius: "36px 8px 8px 8px",
    border: "2px solid #BBD5B2",
    whiteSpace: "nowrap",
  },
  secondLine: {
    width: "fit-content",
...
export default function WazirDamTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/wazirdam/fonts/TajawalBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/wazirdam/images/logo.png")}
