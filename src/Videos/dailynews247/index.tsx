...
const TEMPLATE_FONT = "AlexandriaBold";
const PRIMARY_COLOR = "#a9161a";
...
export default function DailyNews247Template({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/dailynews247/fonts/AlexandriaBold.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/dailynews247/images/logo.png")}
        style={{ position: "absolute", top: 220, left: 0, width: 520 }}
      />
