...
const TEMPLATE_FONT = "HuwiyaArabicBold";
const PRIMARY_COLOR = "#ff0100";
...
export default function TurkeyPulseTemplate({data}: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/turkeypulse/fonts/HuwiyaArabicBold.otf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/turkeypulse/images/logo.png")}
        style={{position: "absolute", top: 270, left: 100, width: 200}}
      />
