...
const TEMPLATE_FONT = "HacenTunisiaBold";
const PRIMARY_COLOR = "#e2393d";
...
export default function NewsArTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/newsar/fonts/HacenTunisiaBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/newsar/images/logo.png")}
        style={{ position: "absolute", top: 240, left: 110, width: 200 }}
      />
