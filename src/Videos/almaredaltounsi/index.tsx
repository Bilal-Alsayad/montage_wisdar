...
const TEMPLATE_FONT = "AlmaredaltounsiGESSSTwoMedium";
const PRIMARY_COLOR = "#7a0806";
...
const TITLE_STYLES: TitleAnimationStyles = {
  container: {
    ...
    borderRadius: 0,
    boxShadow: `
      inset 0 0 0 4px #6B2E1E,
      inset 0 0 0 7px #B77A39,
      0 0 0 2px #71331F
    `,
    display: "flex",
    alignItems: "center",
...
export default function AlmaredaltounsiTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("pulitkat/almaredaltounsi/fonts/GE_SS_Two_Medium.otf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("pulitkat/almaredaltounsi/images/logo.png")}
        style={{ position: "absolute", top: 270, left: 110, width: 200 }}
      />
      {data.captions.src && (
        <Captions
