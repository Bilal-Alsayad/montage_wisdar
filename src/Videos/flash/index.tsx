...
const TEMPLATE_FONT = "29LTBukraBold";
const PRIMARY_COLOR = "#c02733";
...
export default function FlashTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/flash/fonts/29LTBukraBold.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/flash/images/logo.png")}
