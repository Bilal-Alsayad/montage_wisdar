...
export default function Arabi21SportTemplate({
  outroStartFrame,
  ...
  const fontsLoaded = useLoadFonts([
    {
      ...
      url: `${staticFile("arabi21sport/fonts/ITFHuwiyaArabicBold.otf")}`,
    },
    {
      family: itfHuwiyaArabicMedium,
      url: `${staticFile("arabi21sport/fonts/ITFHuwiyaArabicMedium.otf")}`,
    },
    {
      family: itfHuwiyaArabicRegular,
      url: `${staticFile("arabi21sport/fonts/ITFHuwiyaArabicRegular.otf")}`,
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={outroStartFrame} durationInFrames={outroDurationInFrames}>
        <OffthreadVideo
          src={`${staticFile("arabi21sport/elements/outro.webm")}`}
          style={{ zIndex: 100 }}
          transparent
        />
      </Sequence>
      ...
      <Loop durationInFrames={LOGO_DURATION_FRAMES}>
        <OffthreadVideo
          src={`${staticFile("arabi21sport/elements/logo.webm")}`}
          style={{ zIndex: 99 }}
          transparent
        />
      </Loop>
