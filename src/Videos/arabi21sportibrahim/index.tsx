...
const TEMPLATE_FONT = "ITCHandelGothicArabicHeavy";
const PRIMARY_COLOR = "#84c57f";
...
export default function Arabi21SportIbrahimTemplate({data}: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/arabi21sportibrahim/fonts/ITCHandelGothicArabicHeavy.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/arabi21sportibrahim/images/logo.png")}
        style={{position: "absolute", top: 180, left: 110, width: 160}}
      />
