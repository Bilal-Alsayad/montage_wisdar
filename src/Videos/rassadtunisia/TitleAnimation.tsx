...
export default function TitleAnimation({
  ...
  // ─── Box 1 opacity ───
  const box1Enter = interpolate(
    frame,
    [BOX1_FADE_START, BOX1_FADE_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_FADE },
  );
  const box1Exit = interpolate(
    reverseFrame,
    [BOX1_FADE_START, BOX1_FADE_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_FADE },
  ...
  // ─── Box 2 opacity ───
  const box2Enter = interpolate(
    frame,
    [BOX2_FADE_START, BOX2_FADE_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_FADE },
  );
  const box2Exit = interpolate(
    reverseFrame,
    [BOX2_FADE_START, BOX2_FADE_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_FADE },
  ...
  const imgSlideEnter = interpolate(
    frame,
    [IMG_SLIDE_START, IMG_SLIDE_END],
    [100, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_SLIDE },
  );
  const imgSlideExit = interpolate(
    reverseFrame,
    [IMG_SLIDE_START, IMG_SLIDE_END],
    [100, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_SLIDE },
  ...
  const imgFadeEnter = interpolate(
    frame,
    [IMG_SLIDE_START, IMG_SLIDE_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_FADE },
  );
  const imgFadeExit = interpolate(
    reverseFrame,
    [IMG_SLIDE_START, IMG_SLIDE_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_FADE },
  ...
  const text1RevealEnter = interpolate(
    frame,
    [TEXT1_START, TEXT1_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_TEXT },
  );
  const text1RevealExit = interpolate(
    reverseFrame,
    [TEXT1_START, TEXT1_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_TEXT },
  ...
  const text1SlideEnter = interpolate(
    frame,
    [TEXT1_START, TEXT1_END],
    [60, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_SLIDE },
  );
  const text1SlideExit = interpolate(
    reverseFrame,
    [TEXT1_START, TEXT1_END],
    [60, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_SLIDE },
  ...
  const text2RevealEnter = interpolate(
    frame,
    [TEXT2_START, TEXT2_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_TEXT },
  );
  const text2RevealExit = interpolate(
    reverseFrame,
    [TEXT2_START, TEXT2_END],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_TEXT },
  ...
  const text2SlideEnter = interpolate(
    frame,
    [TEXT2_START, TEXT2_END],
    [60, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_SLIDE },
  );
  const text2SlideExit = interpolate(
    reverseFrame,
    [TEXT2_START, TEXT2_END],
    [60, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: EASE_SLIDE },
  ...
  const squareAnim = (start: number, maxOpacity: number) => {
    ...
    const opEnter = interpolate(frame, [start, end], [0, maxOpacity], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: EASE_FADE,
    });
    const opExit = interpolate(reverseFrame, [start, end], [0, maxOpacity], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: EASE_FADE,
    });
    const txEnter = interpolate(frame, [start, end], [40, 0], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: EASE_SLIDE,
    });
    const txExit = interpolate(reverseFrame, [start, end], [40, 0], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: EASE_SLIDE,
    });
      ...
      >
        <div
          style={{
            ...
            background: "#e61f30",
            opacity: sq4.opacity,
            transform: `translateX(${sq4.translateX}px)`,
            boxShadow: "0 0 24px 3.36px rgba(230, 31, 48, 0.53)",
          }}
        />
        <div
          style={{
            ...
            background: "#e61f30",
            opacity: sq3.opacity,
            transform: `translateX(${sq3.translateX}px)`,
            boxShadow: "0 0 24px 3.36px rgba(230, 31, 48, 0.53)",
          }}
        />
        <div
          style={{
            ...
            background: "#e61f30",
            opacity: sq2.opacity,
            transform: `translateX(${sq2.translateX}px)`,
            boxShadow: "0 0 24px 3.36px rgba(230, 31, 48, 0.53)",
          }}
        />
        <div
          style={{
            ...
            background: "#e61f30",
            opacity: sq1.opacity,
            transform: `translateX(${sq1.translateX}px)`,
            boxShadow: "0 0 24px 3.36px rgba(230, 31, 48, 0.53)",
          }}
        />
      </div>
