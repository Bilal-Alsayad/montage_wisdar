    ...
    <AbsoluteFill>
      <Sequence from={0} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/breakingar/images/location.png")}
        />

        <AnimatedTag
          text={date}
          styles={styles.date}
          iconSrc={staticFile("short/breakingar/images/date.png")}
      ...
      <Sequence from={150} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/breakingar/images/source.png")}
        />
      </Sequence>
    </AbsoluteFill>
  );
