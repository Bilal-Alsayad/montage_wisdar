...
const TITLE_STYLES: TitleAnimationStyles = {
  ...
  secondLine: {
    ...
    background: "linear-gradient(90deg, #8B1E2A 0%, #4B1118 100%)",
    color: "#F3E8D2",
    border: "3px solid #8B1E2A",
    borderRadius: "0 0 22px 22px",
    boxShadow: "0 10px 0 #A1827A",
    whiteSpace: "nowrap",
  },
};
...
export default function TounesContreTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/tounescontre/fonts/TajawalBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/tounescontre/images/logo.png")}
