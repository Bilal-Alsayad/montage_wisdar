...
// --- ÃœÃ§ tag (location, date, source) aynÄ± animasyonu paylaÅŸÄ±yor.
// Tek fark: hangi ikon dosyasÄ± kullanÄ±ldÄ±ÄŸÄ±, ikonun opacity zamanlamasÄ±
    ...
    <AbsoluteFill>
      <Sequence from={0} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/tounescontre/images/location.png")}
        />

        <AnimatedTag
          text={date}
          styles={styles.date}
          iconSrc={staticFile("short/tounescontre/images/date.png")}
      ...
      <Sequence from={150} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/tounescontre/images/source.png")}
        />
      </Sequence>
    </AbsoluteFill>
  );
