...
const TEMPLATE_FONT = "AlJazeeraArabicRegular";
const PRIMARY_COLOR = "#00a451";
...
export default function TrendsFactsTemplate({data}: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/trendsfacts/fonts/AlJazeeraArabicRegular.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/trendsfacts/images/logo.png")}
        style={{position: "absolute", top: 240, left:70, width: 250}}
      />
      ...
      {data.captions.src && (
        <Captions
          ...
          containerStyle={{
            top: 1400,
            backgroundColor: hexToRgba(PRIMARY_COLOR, 0.64),
