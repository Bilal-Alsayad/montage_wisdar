...
const TEMPLATE_FONT = "DroidArabicKufiBold";
const PRIMARY_COLOR = "#98353c";
...
export default function ProWrestleHubTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/prowrestlehub/fonts/DroidArabicKufiBold.TTF"),
    },
  ]);
