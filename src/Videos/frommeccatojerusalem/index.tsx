...
export default function FromMeccaToJerusalemTemplate({data}: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/frommeccatojerusalem/fonts/AlJazeeraBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/frommeccatojerusalem/images/logo.png")}
