...
const TITLE_STYLES: TitleAnimationStyles = {
  ...
  secondLine: {
    ...
    maxWidth: "100%",
    padding: "20px 46px",
    background: "linear-gradient(90deg, #0A1E88 0%, #040B34 100%)",
    borderRight: "20px solid #FFFFFF",
    boxShadow: "0 12px 0 #0A1E88",
    whiteSpace: "nowrap",
  },
};
...
export default function SibSalahTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/sibsalah/fonts/TajawalBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/sibsalah/images/logo.png")}
