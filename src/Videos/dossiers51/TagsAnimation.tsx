    ...
    <AbsoluteFill>
      <Sequence from={0} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/dossiers51/images/location.png")}
        />

        <AnimatedTag
          text={date}
          styles={styles.date}
          iconSrc={staticFile("short/dossiers51/images/date.png")}
      ...
      <Sequence from={150} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/dossiers51/images/source.png")}
        />
      </Sequence>
    </AbsoluteFill>
  );
