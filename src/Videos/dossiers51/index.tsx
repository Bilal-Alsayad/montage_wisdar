...
const TITLE_STYLES: TitleAnimationStyles = {
  ...
  firstLine: {
    width: "fit-content",
    maxWidth: "100%",
    padding: "22px 54px 22px 38px",
    backgroundColor: "#E8C9A3",
    borderRight: "14px solid #D96F16",
    borderTop: "3px solid #7A3E12",
    whiteSpace: "nowrap",
  },
  secondLine: {
    width: "fit-content",
    maxWidth: "100%",
    padding: "20px 54px 22px 38px",
    backgroundColor: "#D96F16",
    color: "#FFF7EB",
    borderRight: "14px solid #B7611B",
    boxShadow: "-10px 10px 0 #7A3E12",
    whiteSpace: "nowrap",
  },
};
...
export default function Dossiers51Template({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/dossiers51/fonts/TajawalBold.TTF"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/dossiers51/images/logo.png")}
