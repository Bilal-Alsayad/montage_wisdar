...
const TEMPLATE_FONT = "DINNextArabicBold";
const PRIMARY_COLOR = "#ff9934";
...
export default function SharqTemplate({data}: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/sharq/fonts/DINNextArabicBold.otf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/sharq/images/logo.png")}
