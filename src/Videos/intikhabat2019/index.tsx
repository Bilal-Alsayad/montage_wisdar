...
const TEMPLATE_FONT = "Intikhabat2019HelveticaNeueLT";
const PRIMARY_COLOR = "#e10f02";
...
export default function Intikhabat2019Template({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("pulitkat/intikhabat2019/fonts/HelveticaNeueLT.otf"),
    },
  ]);
