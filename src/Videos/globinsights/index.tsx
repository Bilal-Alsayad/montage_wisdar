...
const TEMPLATE_FONT = "HACEN TUNISIA BOLD";
const PRIMARY_COLOR = "#011032";
...
export default function GlobinsightsTemplate({
  data,
  ...
  const fontsLoaded = useLoadFonts([
    {
      ...
      url: staticFile("short/globinsights/fonts/HACEN TUNISIA BOLD.ttf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/globinsights/images/logo.png")}
        style={{ position: "absolute", top: 240, left: 80, width: 250 }}
      />
      ...
      <Sequence from={outroStartFrame} durationInFrames={outroDurationInFrames}>
        <OffthreadVideo
          src={staticFile("short/globinsights/images/outro.webm")}
          transparent
          style={{
            width: "100%",
            height: "100%",
