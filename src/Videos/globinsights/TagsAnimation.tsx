    ...
    <AbsoluteFill>
      <Sequence from={0} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/globinsights/images/location.png")}
        />

        <AnimatedTag
          text={date}
          styles={styles.date}
          iconSrc={staticFile("short/globinsights/images/date.png")}
      ...
      <Sequence from={150} durationInFrames={TAG_DURATION}>
        <AnimatedTag
          ...
          iconSrc={staticFile("short/globinsights/images/source.png")}
        />
      </Sequence>
    </AbsoluteFill>
  );
