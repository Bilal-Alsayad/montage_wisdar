...
const TEMPLATE_FONT = "OmniaNaskhBold";
const PRIMARY_COLOR = "#88321e";
...
export default function ArabVarietyTemplate({ data }: TemplateProps) {
  const fontsLoaded = useLoadFonts([
    {
      family: TEMPLATE_FONT,
      url: staticFile("short/arabvariety/fonts/OmniaNaskhBold.otf"),
    },
  ]);
  ...
  return (
    <AbsoluteFill>
      ...
      <Img
        src={staticFile("short/arabvariety/images/logo.png")}
        style={{ position: "absolute", top: 300, left: 100, width: 160 }}
      />
